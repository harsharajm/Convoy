...
from config import (
    BATCH_SIZE, BUFFER_CAPACITY, CLIENTS, EPOCHS_PER_TASK, GATE_BATCH_SIZE,
    GOSSIP_EVERY_N_STEPS, GOSSIP_FANOUT, GOSSIP_LAMBDA, GOSSIP_PARTICIPATION,
    MODES, NUM_CLASSES, NUM_WORKERS, REPLAY_RATIO, SEED, TASKS, USE_AMP,
)
...
def run_joint(seed=SEED, device=None, out_dir="results/runs", max_steps=None, tag=""):
    ...
    results = {"mode": "joint", "seed": seed, "steps": step,
